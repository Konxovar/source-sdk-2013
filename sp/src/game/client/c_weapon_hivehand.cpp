...
CLIENTEFFECT_REGISTER_BEGIN( PrecacheEffectHivehand )
...
class C_WeaponHivehand : public C_BaseCombatWeapon
{
	DECLARE_CLASS(C_WeaponHivehand, C_BaseCombatWeapon);
	DECLARE_CLIENTCLASS();
};

class C_HornetBullet : public C_BaseCombatCharacter
{
	DECLARE_CLASS(C_HornetBullet, C_BaseCombatCharacter);
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_HornetBullet(const C_HornetBullet &); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT(C_WeaponHivehand, DT_WeaponHivehand, CWeaponHivehand)
END_RECV_TABLE()

IMPLEMENT_CLIENTCLASS_DT(C_HornetBullet, DT_HornetBullet, CHornetBullet)
END_RECV_TABLE()
...
// Purpose: 
//-----------------------------------------------------------------------------
C_HornetBullet::C_HornetBullet(void)
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_HornetBullet::OnDataChanged(DataUpdateType_t updateType)
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_HornetBullet::DrawModel(int flags)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_HornetBullet::ClientThink(void)
{
	m_bUpdated = false;
}
...
DECLARE_CLIENT_EFFECT( "HivehandLoad", CrosshairLoadCallback );
